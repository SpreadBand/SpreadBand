...
urlpatterns = patterns('',
    ...
    url(r'^(?P<band_slug>[-\w]+)/presskit/viewrequest/(?P<viewrequest_id>\d+)/band_comment$', views.presskit_viewrequest_band_comment, name='presskit-viewrequest-band-comment'),
